...
__decorate([
    ...
    (0, swagger_1.ApiBody)({ type: create_building_dto_1.CreateBuildingInput }),
    (0, swagger_1.ApiResponse)({ status: 201, description: "Building created", type: building_entity_1.Building }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_building_dto_1.CreateBuildingInput]),
    __metadata("design:returntype", Promise)
], BuildingsController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: "Get list of all buildings" }),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: "Building details", type: building_entity_1.Building }),
...
__decorate([
    (0, common_1.Patch)(":id"),
    (0, swagger_1.ApiOperation)({ summary: "Update building by ID" }),
    (0, swagger_1.ApiParam)({ name: "id", type: Number }),
...
exports.BuildingsController = BuildingsController = __decorate([
    ...
    __metadata("design:paramtypes", [building_service_1.BuildingsService])
], BuildingsController);
